    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        <section style={styles.card}>
          <p style={styles.kicker}>JOIN LOOM</p>
          <h1 style={styles.title}>Create account</h1>
          <p style={styles.subtitle}>Sign up to publish and discover verified human-made artwork.</p>
          ...
          <div style={styles.metaText}>Already have an account?</div>
          <Link to="/login" className="auth-bottom-link" style={styles.linkCta}>
            LOG IN
          </Link>
...
const styles = {
  ...
  bgTexture: {
    position: "absolute",
    inset: 0,
    backgroundImage: `linear-gradient(rgba(255, 251, 243, 0.88), rgba(255, 251, 243, 0.88)), url(${weavingBg})`,
